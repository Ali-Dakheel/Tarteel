...
class LessonTest extends TestCase
{
    ...
    {
        $lesson = Lesson::factory()->create(['slug' => 'test-lesson']);
    ...
    {
        $lesson = Lesson::factory()->create(['slug' => 'progress-lesson']);
    ...
    {
        Lesson::factory()->create(['slug' => 'no-progress']);
    ...
    {
        $lesson = Lesson::factory()->create(['slug' => 'mark-lesson']);
    ...
    {
        $lesson = Lesson::factory()->create(['slug' => 'update-lesson']);
    ...
    {
        Lesson::factory()->create(['slug' => 'validate-lesson']);
